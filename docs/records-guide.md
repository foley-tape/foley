...
出厂唱片三曲出自 **[HoliznaCC0](https://freemusicarchive.org/music/holiznacc0/)** ——把整张
《Public Domain Lofi》捐入公共领域的人类音乐人。CC0 意味着法律上无须署名；我们署名，因为机器
播的是人做的歌。喜欢这些声音，请直接支持作者：Patreon / Buy Me A Coffee 链接见其 FMA 与
Bandcamp（holiznacc0.bandcamp.com）主页。

【槽·船长】致谢措辞定稿与英文版（README Records 段同源）：＿＿＿＿
【槽·船长】委托首版唱片（§0.4）：艺术家名＋合作故事一句＋授权形式（买断/授权书）：＿＿＿＿

（床音织体三件的作者致谢见 `sound/assets/LICENSES.md`：leonelmail／joedeshon／3bagbrew，
Freesound CC0——同样：无须署名，我们照署。）
