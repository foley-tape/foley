...
<sub>First deck: TAPE·ZERO</sub>

<!-- HERO IMAGE: still-4-deck-storm.png — the full deck, ink climbing, needle in the red -->
...
<!-- IMAGE: still-5-loupe-macro.png — the counter loupe, a carry caught mid-roll -->
...
In progress: a continuous lo-fi bed where *the tape itself ages* as tension rises — hiss thickens, wow deepens, highs dull — and clears again when the trouble passes. Rain stopping isn't a chime; it's the room going quiet. See the [sensory design whitepaper](docs/canon/WHITEPAPER_SENSES.md).
